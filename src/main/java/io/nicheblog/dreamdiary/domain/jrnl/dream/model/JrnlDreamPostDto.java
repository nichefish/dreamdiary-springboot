...
public class JrnlDreamPostDto
        extends BasePostDto
        implements Identifiable<Integer>, CommentCmpstnModule, TagCmpstnModule, Comparable<JrnlDreamPostDto> {
    ...
    @SneakyThrows
    @Override
    public int compareTo(final @NotNull JrnlDreamPostDto other) {
